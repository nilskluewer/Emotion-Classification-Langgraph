...
> *Headline*: Ich - zwar Nichtraucher - wär hier für eine freiwillige Rosskur...
didi111 schreibt:
...
def call_google(reponse_schema, messages: List[dict], model: str = "gemini-1.5-pro-002", temperature: float = 0.0, top_p: float = 0.0) -> str:
